...
Public Function GetOpenFileNames(Owner As Form, Optional ByVal PFN As String) As List
    Dim FD As New OpenFileDialog
    FD.MultiSelect = True
    GetFileName Owner, FD, PFN
    Set GetOpenFileNames = MNew.List(vbString, FD.FileNames)
'    With FD
'        .Filter = m_Filter
'        '.InitialDirectory
